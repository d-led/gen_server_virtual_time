...
# Script to generate all Pony example projects
# Usage: mix run scripts/generate_pony_examples.exs

defmodule PonyExampleGenerator do
  @moduledoc """
  Generates all Pony example projects for testing and validation.
  """

  def run do
    IO.puts("""
    ╔═══════════════════════════════════════════════════════════╗
    ║  Generating Pony Example Projects                         ║
    ╚═══════════════════════════════════════════════════════════╝
    """)
  ...
  defp generate_example(name, simulation, project_name) do
    ...
    try do
      ...
      output_dir = "examples/pony_#{name}"
      :ok = ActorSimulation.PonyGenerator.write_to_directory(files, output_dir)

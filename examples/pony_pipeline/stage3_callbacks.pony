...
// Callback trait for: stage3
//
// Implement this trait to add custom behavior!

trait Stage3Callbacks
  fun ref on_message()

class Stage3CallbacksImpl is Stage3Callbacks
  """
  Default implementation of Stage3 callbacks.
  ...
  fun ref on_message() =>
    ...
    _logger.log("Stage3: Processing message")
